...
<body class="bg-gray-100 text-gray-800 font-sans">
    ...
    <header class="bg-yellow-500 text-white shadow-lg py-6">
        <div class="container mx-auto flex justify-between items-center">
            ...
            <nav class="space-x-6">
                <!-- Voorbeeldlinks (pas aan naar jouw routes) -->
    ...
    <main class="container mx-auto px-4 py-8">
        ...
        <p class="text-lg text-gray-700 mb-6 leading-relaxed">
            ...
            Met de beste ingrediënten en veel liefde in elke deegbodem zorgen we ervoor dat elke pizza een 
            ware smaakbeleving wordt. Of je nu houdt van een klassieke Margherita, een pittige Pepperoni 
        ...
        <!-- Handige links of CTA's (pas aan naar eigen routes) -->
    ...
    <footer class="bg-gray-800 text-gray-400 text-center py-4 mt-8">
        <p>&copy; 2024 Pizzeria. Alle Rechten Voorbehouden. 
            <a href="#" class="text-yellow-500 hover:underline">Privacybeleid</a>
        </p>
    </footer>
</body>
</html>
