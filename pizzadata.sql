...
--
-- Host: 127.0.0.1
-- Gegenereerd op: 17 dec 2024 om 11:39
...
CREATE TABLE `bestellingen` (
  ...
  `klant_id` bigint(20) UNSIGNED NOT NULL,
...
CREATE TABLE `bestelregels` (
  ...
  `afmeting` varchar(255) NOT NULL,
  `pizza_id` bigint(20) UNSIGNED NOT NULL,
  `bestelling_id` bigint(20) UNSIGNED NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
(4, '2024_12_17_100956_create_klanten_table', 1),
(5, '2024_12_17_101000_create_ingredient_pizza_table', 2),
(6, '2024_12_17_101000_create_pizzas_table', 2),
(7, '2024_12_17_102347_create_ingredient_pizza_table', 3);
...
(1, 'Test User', 'test@example.com', '2024-12-17 09:26:47', '$2y$12$lZB2y3/ry5qMvTXPMDLf2uc6cMmJVSrhlr5UAQAZZt/uMZGZVxEV.', '4xIBNeiVJq', '2024-12-17 09:26:47', '2024-12-17 09:26:47');
...
--
-- Indexen voor tabel `ingredient_pizza`
--
ALTER TABLE `ingredient_pizza`
  ADD KEY `ingredient_pizza_pizza_id_foreign` (`pizza_id`),
  ADD KEY `ingredient_pizza_ingredient_id_foreign` (`ingredient_id`);
...
ALTER TABLE `klanten`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `klanten_emailadres_unique` (`emailadres`);
